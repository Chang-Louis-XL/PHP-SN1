...
// UPDATE `students` SET`dept`=2
// UPDATE `students` SET`dept`=2 WHERE `dept`=1 .
// INSERT INTO `dept` (`code`,`name`) VALUES('801','綜合演藝學系')
// DELETE FROM `student` WHERE `id`='1'
// INSERT INTO `dept` (`code`,`name`) VALUES('801','綜合演')
